...
url = "https://login.microsoftonline.com/<Application id of registered App on Azure>/oauth2/v2.0/authorize?client_id=<Client Id>&response_type=code&response_mode=query&scope=https%3A%2F%2Fgraph.microsoft.com%2F.default&state=12345"
